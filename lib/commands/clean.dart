...
class WebosCleanCommand extends CleanCommand {
  WebosCleanCommand({super.verbose});

  /// See: [CleanCommand.runCommand] in `clean.dart`
  @override
  Future<FlutterCommandResult> runCommand() async {
    final FlutterProject flutterProject = FlutterProject.current();
    _cleanWebosProject(WebosProject.fromFlutter(flutterProject));

    return super.runCommand();
  }

  void _cleanWebosProject(WebosProject project) {
